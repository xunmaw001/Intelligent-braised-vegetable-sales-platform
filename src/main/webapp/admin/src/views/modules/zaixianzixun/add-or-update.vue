<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="卤菜分类" prop="lucaifenlei">
          <el-input v-model="ruleForm.lucaifenlei" 
              placeholder="卤菜分类" clearable  :readonly="ro.lucaifenlei"></el-input>
        </el-form-item>
        <div v-else>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.zixunneirong = this.ruleForm.zixunneirong.replace(reg,'../../../ssmg6au9/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
