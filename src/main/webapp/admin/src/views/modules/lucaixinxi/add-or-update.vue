<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="卤菜名称" prop="lucaimingcheng">
          <el-input v-model="ruleForm.lucaimingcheng" 
              placeholder="卤菜名称" clearable  :readonly="ro.lucaimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="卤菜名称" prop="lucaimingcheng">
              <el-input v-model="ruleForm.lucaimingcheng" 
                placeholder="卤菜名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="卤菜分类" prop="lucaifenlei">
          <el-select :disabled="ro.lucaifenlei" v-model="ruleForm.lucaifenlei" placeholder="请选择卤菜分类">
            <el-option
                v-for="(item,index) in lucaifenleiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="卤菜分类" prop="lucaifenlei">
	      <el-input v-model="ruleForm.lucaifenlei"
                placeholder="卤菜分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="制作日期" prop="zhizuoriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.zhizuoriqi" 
                type="date"
                :readonly="ro.zhizuoriqi"
                placeholder="制作日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.zhizuoriqi" label="制作日期" prop="zhizuoriqi">
              <el-input v-model="ruleForm.zhizuoriqi" 
                placeholder="制作日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="积分" prop="jf">
          <el-input v-model="ruleForm.jf" 
              placeholder="积分" clearable  :readonly="ro.jf"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="积分" prop="jf">
              <el-input v-model="ruleForm.jf" 
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="卤菜详情" prop="lucaixiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.lucaixiangqing" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.lucaixiangqing" label="卤菜详情" prop="lucaixiangqing">
                    <span v-html="ruleForm.lucaixiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='lucaimingcheng'){
            this.ruleForm.lucaimingcheng = obj[o];
	    this.ro.lucaimingcheng = true;
            continue;
          }
          if(o=='tupian'){
	    ...
	    this.ro.tupian = true;
          ...
          if(o=='lucaifenlei'){
            this.ruleForm.lucaifenlei = obj[o];
	    this.ro.lucaifenlei = true;
            continue;
          }
          if(o=='guige'){
	    ...
	    this.ro.kouwei = true;
          ...
          if(o=='zhizuoriqi'){
            this.ruleForm.zhizuoriqi = obj[o];
	    this.ro.zhizuoriqi = true;
            continue;
          }
          if(o=='baozhiqi'){
	    ...
	    this.ro.baozhiqi = true;
          ...
          if(o=='lucaixiangqing'){
            this.ruleForm.lucaixiangqing = obj[o];
	    this.ro.lucaixiangqing = true;
            continue;
          }
      ...
      this.$http({
		...
		if(json.shangjiadizhi!=''&&json.shangjiadizhi){
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/lucaifenlei/lucaifenlei`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.lucaifenleiOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
	...
	this.ruleForm.lucaixiangqing = this.ruleForm.lucaixiangqing.replace(reg,'../../../ssmg6au9/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `lucaixinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.lucaixinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
